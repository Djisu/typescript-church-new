...
export const sendResetEmailMember = (email, token) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    const resetUrl = `${frontendUrl}/member/reset-password?token=${token}&env=${nodeEnv}`;
...
//# sourceMappingURL=emailMember.js.map